...
const dataMap = {
  DE: {
    fua: {
      "1ew":    { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Alleinlebend", q1: '1', median: '1,8', q3: '3,2', n: 562 },
      "1ew1k":  { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Ein Erwachsener mit einem Kind", q1: '2', median: '3,8', q3: '5,3', n: 121 },
      ...
      "2ew":    { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Zwei Erwachsene", q1: '1,2', median: '2,2', q3: '4', n: 867 },
      "2ew1k":  { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Zwei Erwachsene mit einem Kind", q1: '2,5', median: '4,3', q3: '7', n: 232 },
      ...
      "3ew":    { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Drei Erwachsene", q1: '1,3', median: '3', q3: '6,5', n: 368 },
      "3ew1k":  { titel: "Frauen - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Drei Erwachsene mit einem Kind", q1: '3,4', median: '6', q3: '9,3', n: 142 },
    ...
    fea: {
        ...
        "2ew":    { titel: "Frauen - Erwerbsarbeit", hhtype: "Zwei Erwachsene", q1: '6', median: '7,8', q3: '9', n: 591 },
        "2ew1k":  { titel: "Frauen - Erwerbsarbeit", hhtype: "Zwei Erwachsene mit einem Kind", q1: '5', median: '6,2', q3: '8,3', n: 142 },
        "2ew2k":  { titel: "Frauen - Erwerbsarbeit", hhtype: "Zwei Erwachsene mit mehr als einem Kind", q1: '4,7', median: '6', q3: '8', n: 219 },
        "3ew":    { titel: "Frauen - Erwerbsarbeit", hhtype: "Drei Erwachsene", q1: '5,5', median: '8', q3: '9', n: 197 },
        "3ew1k":  { titel: "Frauen - Erwerbsarbeit", hhtype: "Drei Erwachsene mit einem Kind", q1: '4,1', median: '6', q3: '8,4', n: 59 },
        "3ew2k":  { titel: "Frauen - Erwerbsarbeit", hhtype: "Drei Erwachsene mit mehr als einem Kind", q1: '5,3', median: '7,5', q3: '9', n: 17 }
    },
    mua: {
      ...
      "2ew1k":  { titel: "Männer - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Zwei Erwachsene mit einem Kind", q1: '1', median: '1,8', q3: '3,5', n: 158 },
      "2ew2k":  { titel: "Männer - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Zwei Erwachsene mit mehr als einem Kind", q1: '0,8', median: '1,7', q3: '3', n: 273 },
      ...
      "3ew2k":  { titel: "Männer - Unbezahlte Arbeit (Haushalt und Kinderbetreuung)", hhtype: "Drei Erwachsene mit mehr als einem Kind", q1: '1,2', median: '1,7', q3: '3', n: 25 }
    },
    mea: {
      "1ew":    { titel: "Männer - Erwerbsarbeit", hhtype: "Alleinlebend", q1: '7,5', median: '8,5', q3: '9,7', n: 365 },
      "1ew1k":  { titel: "Männer - Erwerbsarbeit", hhtype: "Ein Erwachsener mit einem Kind", q1: '8', median: '9,2', q3: '10,5', n: 21 },
      "1ew2k":  { titel: "Männer - Erwerbsarbeit", hhtype: "Ein Erwachsener mit mehr als einem Kind", q1: '6,8', median: '8,5', q3: '10', n: 14 },
      ...
      "2ew2k":  { titel: "Männer - Erwerbsarbeit", hhtype: "Zwei Erwachsene mit mehr als einem Kind", q1: '8', median: '9', q3: '10', n: 286 },
      "3ew":    { titel: "Männer - Erwerbsarbeit", hhtype: "Drei Erwachsene", q1: '7,5', median: '8,7', q3: '10', n: 307 },
      "3ew1k":  { titel: "Männer - Erwerbsarbeit", hhtype: "Drei Erwachsene mit einem Kind", q1: '7,6', median: '9', q3: '9,8', n: 112 },
      "3ew2k":  { titel: "Männer - Erwerbsarbeit", hhtype: "Drei Erwachsene mit mehr als einem Kind", q1: '8,2', median: '9,8', q3: '10,9', n: 32 }
    }
  },
  EN: {
    fua: {
      "1ew":    { titel: "Women - Care Work", hhtype: "Living Alone", q1: '1', median: '1,8', q3: '3,2', n: 562 },
      "1ew1k":  { titel: "Women - Care Work", hhtype: "One Adult with One Child", q1: '2', median: '3,8', q3: '5,3', n: 121 },
      "1ew2k":  { titel: "Women - Care Work", hhtype: "One Adult with More Than One Child", q1: '3,3', median: '5,2', q3: '6,7', n: 61 },
      "2ew":    { titel: "Women - Care Work", hhtype: "Two Adults", q1: '1,2', median: '2,2', q3: '4', n: 867 },
      "2ew1k":  { titel: "Women - Care Work", hhtype: "Two Adults with One Child", q1: '2,5', median: '4,3', q3: '7', n: 232 },
      "2ew2k":  { titel: "Women - Care Work", hhtype: "Two Adults with More Than One Child", q1: '3,3', median: '5,5', q3: '7,5', n: 345 },
      "3ew":    { titel: "Women - Care Work", hhtype: "Three Adults", q1: '1,3', median: '3', q3: '6,5', n: 368 },
      "3ew1k":  { titel: "Women - Care Work", hhtype: "Three Adults with One Child", q1: '3,4', median: '6', q3: '9,3', n: 142 },
    ...
    fea: {
      ...
      "2ew":    { titel: "Women - Paid Work", hhtype: "Two Adults", q1: '6', median: '7,8', q3: '9', n: 591 },
      "2ew1k":  { titel: "Women - Paid Work", hhtype: "Two Adults with One Child", q1: '5', median: '6,2', q3: '8,3', n: 142 },
      "2ew2k":  { titel: "Women - Paid Work", hhtype: "Two Adults with More Than One Child", q1: '4,7', median: '6', q3: '8', n: 219 },
      "3ew":    { titel: "Women - Paid Work", hhtype: "Three Adults", q1: '5,5', median: '8', q3: '9', n: 197 },
      "3ew1k":  { titel: "Women - Paid Work", hhtype: "Three Adults with One Child", q1: '4,1', median: '6', q3: '8,4', n: 59 },
      "3ew2k":  { titel: "Women - Paid Work", hhtype: "Three Adults with More Than One Child", q1: '5,3', median: '7,5', q3: '9', n: 17 }
    },
    mua: {
      ...
      "2ew1k":  { titel: "Men - Care Work", hhtype: "Two Adults with One Child", q1: '1', median: '1,8', q3: '3,5', n: 158 },
      "2ew2k":  { titel: "Men - Care Work", hhtype: "Two Adults with More Than One Child", q1: '0,8', median: '1,7', q3: '3', n: 273 },
      ...
      "3ew2k":  { titel: "Men - Care Work", hhtype: "Three Adults with More Than One Child", q1: '1,2', median: '1,7', q3: '3', n: 25 }
    },
    mea: {
      "1ew":    { titel: "Men - Paid Work", hhtype: "Living Alone", q1: '7,5', median: '8,5', q3: '9,7', n: 365 },
      "1ew1k":  { titel: "Men - Paid Work", hhtype: "One Adult with One Child", q1: '8', median: '9,2', q3: '10,5', n: 21 },
      "1ew2k":  { titel: "Men - Paid Work", hhtype: "One Adult with More Than One Child", q1: '6,8', median: '8,5', q3: '10', n: 14 },
      ...
      "2ew2k":  { titel: "Men - Paid Work", hhtype: "Two Adults with More Than One Child", q1: '8', median: '9', q3: '10', n: 286 },
      "3ew":    { titel: "Men - Paid Work", hhtype: "Three Adults", q1: '7,5', median: '8,7', q3: '10', n: 307 },
      "3ew1k":  { titel: "Men - Paid Work", hhtype: "Three Adults with One Child", q1: '7,6', median: '9', q3: '9,8', n: 112 },
