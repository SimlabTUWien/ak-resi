...
const textMap = {
    ...
    "soz-infra": {
        ...
        text: [
          "Soziale Infrastrukturen sind genauso essenziell wie technische Netze wie Straßen oder Telefonverbindungen. Zugang zu Kindergärten, Schulen, Ärzt:innen, Krankenhäusern, Pflegeeinrichtungen und ähnlichen sozialen Angeboten ist unverzichtbar für das Funktionieren unserer Gesellschaft. Dennoch diese Einrichtungen nicht überall in gleicher Qualität oder Dichte verfügbar, was regionale Unterschiede in der Lebensqualität verstärken kann. Haushalte in gut ausgestatteten Gemeinden profitieren auf mehreren Ebenen: Sie sparen Wege, Zeit und Kosten, insbesondere für Betreuung, Gesundheit oder Bildung. Das erhöht nicht nur die reale Verfügbarkeit von Einkommen, sondern wirkt sich auch positiv auf Erwerbschancen, Familienorganisation und die Vereinbarkeit von Beruf und Alltag aus.",
